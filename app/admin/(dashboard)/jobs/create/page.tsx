  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          title: "Thành công!",
          description: "Đã tạo job mới thành công.",
        });
        router.push("/admin/jobs");
      } else {
        toast({
          title: "Lỗi!",
          description: result.message || "Không thể tạo job.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Lỗi!",
        description: "Có lỗi xảy ra khi tạo job.",
        variant: "destructive",
      });
    } finally {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Add a new job opening to your recruitment system
          </p>
        </div>
      </div>
